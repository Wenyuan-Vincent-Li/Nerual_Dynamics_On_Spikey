...
exp_des = 'Robustness_static' # define the exp no for data storage
...
for i, j in enumerate(weight_inp):
	...
	sim.reset()
	E_E_connections.set(weight = w_ee, delay = 0.2)
	I_I_connections.set(weight = w_ii, delay = 0.2)
	E_I_connections.set(weight = w_ie, delay = 0.5)
	I_E_connections.set(weight = w_ei, delay = 0.5)
