...
data_1 = sio.loadmat("spikes_test_robostness")
print data_1.keys()
print type(data_1)
# print data_1.block
print type(data_1['block'])
print type(data_1['block']['segments'])
print data_1['block']['segments'][0][0][0]

# plt.figure(1, figsize = (5, 5))
# line_up = plt.plot ([1,2,3], label = 'line1')
# line_down = plt.plot ([3,2,1], label = 'line2')
# plt.legend()
# plt.show()
...
# p_in.write_data("p_in.mat")
# p_out.write_data("p_out.mat")
