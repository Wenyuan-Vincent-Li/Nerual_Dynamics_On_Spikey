...
sim.setup()
Excinp = sim.Population(10, sim.SpikeSourcePoisson(rate = 20.0, start = 0, duration = 500))
...
# print spikes.segments[1].spiketrains[2]
# print spike.segments[0].spiketrains[2]
# print spike.segments[1].spiketrains[2]
...
plt.subplot(3, 1, 2)
plot_spiketrains(spike.segments[1])
# plt.subplot(4, 1, 3)
...
# for i in range(len(spikes.segments)):
...
# 	np.savetxt('./Testfolder/exp=%d.txt' %i, rastor_matrix)
