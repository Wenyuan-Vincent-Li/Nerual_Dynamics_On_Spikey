...
N_e = 15 # number of excitatory neurons
N_i = 5 # number of inhibitatory neurons
Exc_in = 10 # number of excitatory inputs
Inh_in = 10 # number of inhibitatory inputs
weight_ini = 0.05 # define the initial value of the input signal weight 

run_time = 500 # define the simulation time per run
ite_no = 2 # define how many iterations will the simulation be
...
Excinp = sim.Population(Exc_in, sim.SpikeSourceArray(spike_times = stimSpikes[2, :]))
Inhinp = sim.Population(Inh_in, sim.SpikeSourceArray(spike_times = stimSpikes[3, :]))
...
# for i in range(ite_no):
# 	# Ie_A_connections.set(weight = (i + 1) * weight_ini)
# 	# Ii_A_connections.set(weight = (i + 1) * weight_ini)
...
# 	# ==========write the data======================
# 	sim.reset()
# 	Ie_A_connections.set(weight = (i + 2) * weight_ini)
# 	Ii_A_connections.set(weight = (i + 2) * weight_ini)

# =========simulation end==============
all_cells.write_data("spikes_test_robostness.mat")
